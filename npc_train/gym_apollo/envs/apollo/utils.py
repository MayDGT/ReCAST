...
from gym_apollo.envs.modules.map.proto.map_lane_pb2 import Lane, LaneBoundary
...
def dynamic_obstacle_location_to_obstacle(speed: float, loc: Point3D, heading: float) -> PerceptionObstacle:
    """
...
def pointenu_to_point(point_enu:PointENU) -> Point:
    return Point(point_enu.x, point_enu.y)
